            ...
            <div className="space-y-3">
               <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 overflow-hidden">
                  <div className="space-y-2">
                     ...
                     <h1 className="text-3xl lg:text-8xl font-black tracking-tighter text-foreground uppercase italic leading-[0.8] mb-3">
                  ...
                  <div className="grid grid-cols-3 p-1.5 bg-foreground/5 rounded-2xl border border-primary/10 backdrop-blur-xl w-full md:w-[450px]">
                     <button
                        onClick={() => handleModeChange("auto")}
                        className={`px-4 py-4 rounded-xl text-[10px] lg:text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap active:scale-95 ${mode === "auto" ? "bg-primary text-foreground shadow-lg" : "text-foreground/40 hover:text-foreground"}`}
                     >
                        Predicted
                     </button>
                     <button
                        onClick={() => handleModeChange("manual")}
                        className={`px-4 py-4 rounded-xl text-[10px] lg:text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap active:scale-95 ${mode === "manual" ? "bg-primary text-foreground shadow-lg" : "text-foreground/40 hover:text-foreground"}`}
                     >
                        Simulation
                     </button>
                     <button
                        onClick={() => handleModeChange("cgpa")}
                        className={`px-4 py-4 rounded-xl text-[10px] lg:text-[10px] font-black uppercase tracking-widest transition-all whitespace-nowrap active:scale-95 ${mode === "cgpa" ? "bg-primary text-foreground shadow-lg" : "text-foreground/40 hover:text-foreground"}`}
                     >
                        CGPA
                     </button>
                  </div>
               ...
               <div className="flex lg:hidden items-center justify-center gap-3 py-1 text-[8px] font-bold text-foreground/20 uppercase tracking-[0.3em] animate-pulse">
                  <span className="w-4 h-[1px] bg-foreground/10" />
               ...
               {mode !== "cgpa" ? (
                  <>
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 glass-card rounded-[2.5rem] lg:rounded-[4rem] p-8 lg:p-14 border-primary/10 relative overflow-visible group shadow-2xl">
                           ...
                           <div className="relative z-10">
                              <div className="flex items-center justify-between mb-12">
                                 <div className="flex items-center gap-4">
                                    <div className="w-14 h-14 bg-gradient-to-br from-primary to-purple-600 rounded-2xl flex items-center justify-center text-foreground shadow-2xl shadow-primary/40 rotate-3 group-hover:rotate-0 transition-transform duration-500">
                                       <TrendingUp size={28} />
                                    </div>
                                    <div>
                                       <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary mb-1">Live Projection</p>
                                       <p className="text-xs font-bold text-foreground/40">Real-time Calculation</p>
                                    </div>
                                 </div>
                                 <div className="hidden md:block">
                                    <div className="flex gap-1">
                                       {[1, 2, 3, 4, 5].map(i => <div key={i} className={`w-1 h-8 rounded-full ${i <= Math.floor(calculator.sgpaNum / 2) ? 'bg-primary' : 'bg-foreground/5'}`} />)}
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div className="flex flex-col items-center justify-center text-center gap-6 w-full">
                                 <div className="relative">
                                    <h2 className="text-6xl lg:text-[12rem] font-black tracking-tighter italic leading-none text-foreground drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                                       {calculator.sgpa}
                                    </h2>
                     ...
                     <div className="space-y-6">
                        <div className="flex items-center justify-between px-4">
                           <div className="flex items-center gap-3">
                              ...
                              <h3 className="text-xs font-black uppercase tracking-[0.4em] text-foreground/40">Academic Matrix</h3>
                           </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                           {calculator.courseStats.map((course: any, i: number) => (
                              <div key={i} className={`glass-card rounded-[2.5rem] p-8 border border-primary/10 hover:border-primary/20 transition-all duration-500 group relative overflow-hidden ${mode === 'manual' ? 'cursor-pointer hover:bg-primary/[0.02]' : ''}`}>
                                 <div className="relative z-10 flex flex-col h-full justify-between gap-8">
                                    <div className="flex items-start justify-between">
                                       <div className="space-y-1">
                                          ...
                                          <h4 className="text-sm font-bold text-foreground group-hover:text-primary transition-colors line-clamp-2 uppercase italic tracking-tight">
                                             {course.courseTitle}
                                          </h4>
                                       </div>
                                       <button
                                          onClick={() => mode === "manual" && toggleManualGrade(course.courseCode)}
                                          className={`w-16 h-16 shrink-0 bg-foreground/[0.02] border flex items-center justify-center rounded-2xl text-2xl font-black italic transition-all group-hover:scale-110 shadow-2xl ${mode === "manual"
                                             ...
                                             : "cursor-default border-primary/10 text-foreground group-hover:text-primary"
                                             }`}
                                       >
                                          {course.grade}
                                       </button>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-primary/10">
                                       <div>
                                          <p className="text-[9px] font-black text-foreground/20 uppercase tracking-widest mb-1">Credits</p>
                                          <p className="text-lg font-black italic text-foreground/80">{course.credits} <span className="text-[10px] opacity-40">credits</span></p>
                                       </div>
                                       <div className="text-right">
                                          <p className="text-[9px] font-black text-foreground/20 uppercase tracking-widest mb-1">Points</p>
                                          <p className="text-lg font-black italic text-foreground/80">{course.points}</p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
                     <div className="lg:col-span-3 space-y-6">
                        <div className="flex items-center justify-between px-4 mb-4">
                           <p className="text-[10px] font-black uppercase tracking-widest text-foreground/20">Input Matrix</p>
                           <button
                              onClick={() => setSemesters([...semesters, { id: Date.now(), sgpa: "", credits: "" }])}
                              className="flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/20 rounded-xl text-[10px] font-black uppercase text-primary hover:bg-primary hover:text-foreground transition-all shadow-lg shadow-primary/10"
                           >
                              <Plus size={12} />
                              Add Semester
                           </button>
                        ...
                        <div className="space-y-4">
                           {semesters.map((sem) => (
                              <div key={sem.id} className="glass-card rounded-3xl p-6 lg:p-8 border-primary/10 flex flex-col md:flex-row items-center gap-8 animate-in slide-in-from-left-4 duration-500">
                                 <div className="flex-1 grid grid-cols-2 gap-6 w-full">
                                    <div className="space-y-2">
                                       <label className="text-[9px] font-black text-foreground/20 uppercase tracking-widest block ml-1">SGPA Score</label>
                                       <input
                                          ...
                                          className="w-full bg-foreground/[0.03] border border-border/10 rounded-2xl p-4 text-xl font-black italic text-foreground placeholder:text-foreground/5 focus:border-primary/50 focus:ring-4 focus:ring-primary/10 outline-none transition-all"
                                       />
                                    </div>
                                    <div className="space-y-2">
                                       <label className="text-[9px] font-black text-foreground/20 uppercase tracking-widest block ml-1">Credits</label>
                                       <input
                                 ...
                                 <button
                                    ...
                                    className="w-12 h-12 rounded-2xl bg-rose-500/10 text-rose-500 flex items-center justify-center hover:bg-rose-500 hover:text-foreground transition-all shrink-0 border border-rose-500/20"
                                 >
                                    <Trash2 size={18} />
                                 </button>
                              </div>
                        ...
                        <div className="glass-card rounded-[3rem] p-8 lg:p-12 border-primary/20 bg-primary/5 shadow-2xl shadow-primary/10 relative overflow-visible text-center group sticky top-8">
                           ...
                           <div className="relative z-10">
                              ...
                              <div className="relative inline-block mb-10 w-full">
                                 <h2 className="text-5xl lg:text-[9rem] font-black tracking-tighter italic leading-none text-foreground drop-shadow-[0_20px_50px_rgba(0,0,0,0.5)] break-words">
                                    {cgpaResults.cgpa}
                                 </h2>
                              </div>
                              <div className="grid grid-cols-1 gap-4 pt-8 border-t border-primary/10">
                                 <div className="p-5 rounded-3xl bg-foreground/[0.02] border border-primary/10 backdrop-blur-sm">
                                    <p className="text-[10px] font-black text-foreground/20 uppercase tracking-widest mb-1">Lifetime Credits Accumulated</p>
                                    <p className="text-3xl font-black italic text-foreground">{cgpaResults.totalCredits}</p>
                                 </div>
                              </div>
                              <div className="mt-8 p-6 rounded-3xl bg-primary/10 border border-primary/20">
                                 ...
                                 <p className="text-sm font-bold uppercase italic text-foreground">
